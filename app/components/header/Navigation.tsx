        ...
        >
          <ul id="menu-primary-menu" className="menu">
            {navigation?.map((item) => (
              <li
                key={item.id}
                className={`menu-item ${item.dropdown ? "menu-item-has-children" : ""} ${path === item.path ? "current-item" : ""}`}
              >
                {
                  item.path ? (
                  ...
                  item.dropdown && (
                    <ul className="sub-menu">
                      {item.dropdown?.map((item2) => (
                        <li
                          key={item2.id}
                          className={`menu-item ${item2.dropdown ? "menu-item-has-children" : ""
                          ...
                          {item2.dropdown && (
                            <ul className="sub-menu">
                              {item2.dropdown.map((item3) => (
                                <li
                                  key={item3.id}
                                  className={`menu-item ${path === item3.path ? "current-item" : ""
                                    }`}
                                >
